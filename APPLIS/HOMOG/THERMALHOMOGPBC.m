classdef THERMALHOMOGPBC
    ...
    methods
        function obj=THERMALHOMOGPBC(size_domain,nb_elem,ls,neg_side,pos_side)
        ...
        function obj=solve_mode(obj,dim)
            ...
            obj.u_free{dim}=solvesingular(obj.A_free,f-f0);
        ...
        function obj=findeffectiveconductivity(obj)
            ...
            for i=1:obj.dim
                obj.u_unfree_tot{i}=obj.macro_mode_unfree{i}-obj.u_unfree{i};
            end
            for i=1:obj.dim
                for j=1:obj.dim
