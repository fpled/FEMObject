classdef THERMALHOMOGNBC
    ...
    methods
        function obj=THERMALHOMOGNBC(size_domain,nb_elem,ls,neg_side,pos_side)
        ...
        function obj=solve_mode(obj,dim)
            ...
            obj.u_free{dim}=solvesingular(obj.A_free,obj.f{dim}-f0);
    ...
    methods (Access = private)
        ...
        function obj=definebcs(obj)
            ...
            % Dirichlet
            for i=1:obj.dim
                obj.model{i} = addcl(obj.model{i},POINT(point),'T',0);
            end
            % Neumann
            if obj.dim==2
                P=cell(4,1);
