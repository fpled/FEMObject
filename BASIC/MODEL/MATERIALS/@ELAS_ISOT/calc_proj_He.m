...
% tol = 1e-12;
% errsqrtD = max(norm(sqrtDana-sqrtD)/norm(sqrtDana),[],'all'); if errsqrtD>tol, errsqrtD, end
% errsqrtC = max(norm(sqrtCana-sqrtC)/norm(sqrtCana),[],'all'); if errsqrtC>tol, errsqrtC, end
