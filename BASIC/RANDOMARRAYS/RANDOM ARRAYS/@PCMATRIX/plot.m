...
if any(ischarin({'pdf','cdf','icdf','multipdf'},varargin))
    ...
    switch length(RV)
        case 1
            ...
            if isclassin('RANDVARS',varargin) || isclassin('RANDVAR',varargin)
                if isclassin('RANDVAR',varargin)
                    RVplot = getclassin('RANDVAR',varargin);
                    RVplot= RANDVARS(RVplot);
                    varargin = delclassin('RANDVAR',varargin);
                else
