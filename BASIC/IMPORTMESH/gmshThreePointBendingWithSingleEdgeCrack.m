function varargout = gmshThreePointBendingWithSingleEdgeCrack(L,H,ls,w,a,b,t,clD,clC,filename,indim,varargin)
% function varargout = gmshThreePointBendingWithSingleEdgeCrack(L,H,ls,w,a,b,t,clD,clC,filename,indim)
% L : length
% H : height
