function [u,result] = dsolve_arnoldi_gsd_time(GSD,T,b,A,B,u0,varargin)
% function u = dsolve_arnoldi_gsd_time(GSD,T,b,A,B,u0,varargin)
% resolution de A dt(u) + B u= b par approche GSD temporelle
% A B et b : double ou TIMEMATRIX
