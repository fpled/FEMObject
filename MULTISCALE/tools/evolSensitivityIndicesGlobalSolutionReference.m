function mov = evolSensitivityIndicesGlobalSolutionReference(glob,T,Ut_ref,alpha,varargin)
% function mov = evolSensitivityIndicesGlobalSolutionReference(glob,T,Ut_ref,alpha,varargin)
% Display evolution of the sensitivity indices of reference global solution Ut_ref
...
sUt_ref = varianceConditionalExpectation(Ut_ref,alpha)./max(vUt_ref);
