function mov = evolSobolIndicesMultiscaleSolution(glob,patches,interfaces,T,Ut,wt,alpha,varargin)
% function mov = evolSobolIndicesMultiscaleSolution(glob,patches,interfaces,T,Ut,wt,alpha,varargin)
% Display evolution of the Sobol indices of multiscale solution ut=(Ut,wt)
...
if ischarin('displ',varargin)
    ...
    figure('Name',['Sobol index of u_' num2str(i) '=(U_' num2str(i) ',w_' num2str(i) ') over domain for random variables #' num2str(alpha)])
    % set(gcf,'Name',['Sobol index of u_' num2str(i) '=(U_' num2str(i) ',w_' num2str(i) ') over domain for random variables #' num2str(alpha)])
else
    figure('Name',['Sobol index of u=(U,w) over domain for random variables #' num2str(alpha)])
    % set(gcf,'Name',['Sobol index of u=(U,w) over domain for random variables #' num2str(alpha)])
end
clf
set(gcf,'Color','w')
