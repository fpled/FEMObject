function mov = evolStdGlobalLocalSolution(glob,patches,interfaces,T,Ut,wt,varargin)
% function mov = evolStdGlobalLocalSolution(glob,patches,interfaces,T,Ut,wt,varargin)
% Display evolution of the standard deviation of global solution Ut and local solution wt
% glob: Global
% patches: Patches
...
if ischarin('displ',varargin)
    ...
    figure('Name',['Standard deviation of U_' num2str(i) ' and w_' num2str(i) ' over domain and patches'])
    % set(gcf,'Name',['Standard deviation of U_' num2str(i) ' and w_' num2str(i) ' over domain and patches'])
else
    figure('Name','Standard deviation of U and w over domain and patches')
    % set(gcf,'Name','Standard deviation of U and w over domain and patches')
end
clf
set(gcf,'color','w')
...
swt = cellfun(@(patch) TIMEMATRIX(reshape(std(wt{patch.number}),wt{patch.number}.sz),T),patches.patches,'UniformOutput',false);
