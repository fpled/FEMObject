function mov = evolSensitivityIndicesGlobalLocalSolutionReference(glob,patches,interfaces,T,Ut_ref,wt_ref,alpha,varargin)
% function mov = evolSensitivityIndicesGlobalLocalSolutionReference(glob,patches,interfaces,T,Ut_ref,wt_ref,alpha,varargin)
% Display evolution of the sensitivity indices of reference global solution Ut_ref and local solution wt_ref
...
swt_ref = cellfun(@(v) v./repmat(max_var,size(v,1),1),vwt_ref,'UniformOutput',false);
